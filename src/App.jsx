...
const MainContent = () => {
  ...
  const [showHiringPopup, setShowHiringPopup] = useState(() => {
    return localStorage.getItem("hideHiringPopup") !== "true";
  });
  const [showPositions, setShowPositions] = useState(false);
  const carouselRef = useRef(null);

  const handleDontShowAgain = () => {
    localStorage.setItem("hideHiringPopup", "true");
      ...
      {showHiringPopup && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative max-w-4xl w-full bg-gray-800/90 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-gray-700/50 shadow-2xl"
          >
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-2xl" />
            <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full blur-2xl" />
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                ...
                <div className="text-center p-3 sm:p-4 bg-gray-700/30 rounded-xl">
                  <div className="text-xl sm:text-4xl font-bold text-purple-400 mb-1 sm:mb-2">
                    $5k-$20k
                  </div>
                  <div className="text-xs sm:text-sm text-gray-300">
                    Monthly Salary
                ...
                <div className="text-center p-3 sm:p-4 bg-gray-700/30 rounded-xl">
                  <div className="text-xl sm:text-4xl font-bold text-pink-400 mb-1 sm:mb-2">
                    100%
                  </div>
                  <div className="text-xs sm:text-sm text-gray-300">
                    Remote Work
              ...
              <div className="mb-6 sm:mb-8">
                <motion.button
                  ...
                  className="w-full flex items-center justify-between p-4 bg-gray-700/30 rounded-xl border border-gray-600/30 hover:border-blue-500/30 transition-colors duration-300"
                >
                  <h3 className="text-lg sm:text-xl font-semibold text-white">
                    Available Positions
                  </h3>
                  <motion.div
                    animate={{ rotate: showPositions ? 180 : 0 }}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                      {jobTypes.map((job, index) => (
                        <motion.div
                          ...
                          className="p-4 bg-gray-700/30 rounded-xl border border-gray-600/30 hover:border-blue-500/30 transition-colors duration-300"
                        >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl font-medium hover:opacity-90 transition-all duration-300 shadow-lg text-center text-sm sm:text-base"
                >
                  View Openings
                </motion.a>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-gray-700/50 text-white rounded-xl font-medium hover:bg-gray-700/70 transition-all duration-300 text-sm sm:text-base"
                  onClick={() => setShowHiringPopup(false)}
                >
                  Maybe Later
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-6 sm:px-8 py-2 sm:py-3 bg-red-500/20 text-red-400 rounded-xl font-medium hover:bg-red-500/30 transition-all duration-300 border border-red-500/20 text-sm sm:text-base"
